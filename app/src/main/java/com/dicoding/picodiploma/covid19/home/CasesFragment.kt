...
import com.dicoding.picodiploma.core.ui.CovidCasesAdapter
import com.dicoding.picodiploma.covid19.databinding.FragmentCasesBinding
...
class CasesFragment : Fragment() {
    ...
    override fun onViewCreated(
        ...
        if (activity != null) {
            ...
            val casesAdapter = CovidCasesAdapter()
                ...
                if (country != null) {
                    when (country) {
                        ...
                        is Resource.Success -> {
                            ...
                            casesAdapter.setData(country.data)
                        }
                        is Resource.Error -> {
                            binding.progressBar.visibility = View.GONE
