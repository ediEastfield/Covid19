...
class CovidCasesAdapter : RecyclerView.Adapter<CovidCasesAdapter.ListViewHolder>() {
    ...
    inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(data: Country) {
            with(binding) {
                ...
                tvCount.text = NumberFormat.getNumberInstance(Locale("in", "ID")).format(data.confirmed)
            }
        }
